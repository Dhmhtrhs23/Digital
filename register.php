<html>
   ...
   <label for="name">Name:</label>
          ...
          <input type="email" id="mail" name="restaurant">
 ...
 // create layer switcher widget in top right corner of map.
    ...
    map.setCenter (lonLat, zoom);  
       ...
       function register(){
            ...
            var lon = String( Number(map.getCenter().lon) );
            var lat = String( Number(map.getCenter().lat) );

            name = name.replace(' ', "_"); 
            
            window.location.href = "/api.php?data="+  encodeURI( "registerRestaurant|"+name+"|"+email+"|"+restaurant+"|"+description+"|"+lon+"|"+lat );
        } 
       </script>
        <div class="sign"><button  onclick="register()">Publish Restaurant!</button>
